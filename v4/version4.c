...
* @date 25/10/2024
*
* Dans cette quatriéme version, le serpent se déplace téléporte en passant dans les trous percés aux quatres cotés du plateau.
* Aussi, des pommes apparaissent aléatoirement, et le serpent s'allonge et s'aggrandit en les mangeant.
...
#define INIT_X 40
#define INIT_Y 20
/* Initialiser le plateau et ses composants */
#define HAUTEUR 40
#define LARGEUR 80
#define BORDURE '#'
#define VIDE ' '
...
void dessinerSerpent(int taille_serpent,int positionsX[taille_serpent], int positionsY[taille_serpent]);
bool verifSeTouche(int taille_serpent,int positionsX[taille_serpent], int positionsY[taille_serpent]);
void progresser(int taille_serpent,int positionsX[taille_serpent], int positionsY[taille_serpent], char direction,char plateau[HAUTEUR][LARGEUR],bool *peutAvancer,bool *mangeUnePomme);
